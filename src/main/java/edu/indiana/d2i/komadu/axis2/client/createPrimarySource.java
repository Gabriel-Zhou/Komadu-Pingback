...
public class createPrimarySource {
	private KomaduServiceStub stub = null;

	public createPrimarySource(String komaduURL) {
		try {
			// create stub
	...
	public void newPrimarySource(String original_uri, String new_uri,
		...
		// Attribute 1
		AttributeType att1 = createAttribute("Data_PrimarySource", "dummy_val");
