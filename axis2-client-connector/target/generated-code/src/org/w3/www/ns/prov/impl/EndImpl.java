 ...
 */
public class EndImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.www.ns.prov.End
{
    
    public EndImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ENDER$4 = 
        new javax.xml.namespace.QName("http://www.w3.org/ns/prov#", "ender");
     ...
     */
    public org.w3.www.ns.prov.IDRef getEnder()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.www.ns.prov.IDRef target = null;
            target = (org.w3.www.ns.prov.IDRef)get_store().find_element_user(ENDER$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetEnder()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ENDER$4) != 0;
        }
    }
     ...
     */
    public void setEnder(org.w3.www.ns.prov.IDRef ender)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.w3.www.ns.prov.IDRef)get_store().add_element_user(ENDER$4);
            }
            target.set(ender);
        }
    }
     ...
     */
    public org.w3.www.ns.prov.IDRef addNewEnder()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void unsetEnder()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ENDER$4, 0);
        }
    }
