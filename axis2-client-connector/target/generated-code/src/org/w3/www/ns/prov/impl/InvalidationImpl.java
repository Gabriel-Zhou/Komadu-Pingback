 ...
 */
public class InvalidationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.www.ns.prov.Invalidation
{
    
    public InvalidationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public org.w3.www.ns.prov.IDRef getEntity()
    {
        synchronized (monitor())
        {
            ...
            target = (org.w3.www.ns.prov.IDRef)get_store().find_element_user(ENTITY$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setEntity(org.w3.www.ns.prov.IDRef entity)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.w3.www.ns.prov.IDRef)get_store().add_element_user(ENTITY$0);
            }
            target.set(entity);
        }
    }
    ...
    public org.w3.www.ns.prov.IDRef getActivity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.www.ns.prov.IDRef target = null;
            target = (org.w3.www.ns.prov.IDRef)get_store().find_element_user(ACTIVITY$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetActivity()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ACTIVITY$2) != 0;
        }
    }
    ...
    public void setActivity(org.w3.www.ns.prov.IDRef activity)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.w3.www.ns.prov.IDRef)get_store().add_element_user(ACTIVITY$2);
            }
            target.set(activity);
        }
    }
    ...
    public void unsetActivity()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ACTIVITY$2, 0);
        }
    }
