 ...
 */
public class AgentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.www.ns.prov.Agent
{
    ...
    public org.apache.xmlbeans.XmlQName xgetId()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlQName)get_store().find_attribute_user(ID$6);
            return target;
        }
    }
    ...
    public void xsetId(org.apache.xmlbeans.XmlQName id)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlQName)get_store().add_attribute_user(ID$6);
            }
            target.set(id);
        }
    }
