 ...
 */
public class DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.www.ns.prov.Document
{
    ...
    private static final javax.xml.namespace.QName BUNDLECONTENT$68 = 
        new javax.xml.namespace.QName("http://www.w3.org/ns/prov#", "bundleContent");
     ...
     */
    public org.w3.www.ns.prov.NamedBundle[] getBundleContentArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(BUNDLECONTENT$68, targetList);
            org.w3.www.ns.prov.NamedBundle[] result = new org.w3.www.ns.prov.NamedBundle[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public org.w3.www.ns.prov.NamedBundle getBundleContentArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.www.ns.prov.NamedBundle target = null;
            target = (org.w3.www.ns.prov.NamedBundle)get_store().find_element_user(BUNDLECONTENT$68, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public int sizeOfBundleContentArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(BUNDLECONTENT$68);
        }
    }
     ...
     */
    public void setBundleContentArray(org.w3.www.ns.prov.NamedBundle[] bundleContentArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
            arraySetterHelper(bundleContentArray, BUNDLECONTENT$68);
        }
    }
     ...
     */
    public void setBundleContentArray(int i, org.w3.www.ns.prov.NamedBundle bundleContent)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.w3.www.ns.prov.NamedBundle insertNewBundleContent(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.www.ns.prov.NamedBundle target = null;
            target = (org.w3.www.ns.prov.NamedBundle)get_store().insert_element_user(BUNDLECONTENT$68, i);
            return target;
        }
    }
     ...
     */
    public org.w3.www.ns.prov.NamedBundle addNewBundleContent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.www.ns.prov.NamedBundle target = null;
            target = (org.w3.www.ns.prov.NamedBundle)get_store().add_element_user(BUNDLECONTENT$68);
            return target;
        }
    }
     ...
     */
    public void removeBundleContent(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(BUNDLECONTENT$68, i);
        }
    }
}
