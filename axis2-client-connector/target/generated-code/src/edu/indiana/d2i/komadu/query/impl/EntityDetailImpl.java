 ...
 */
public class EntityDetailImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.indiana.d2i.komadu.query.EntityDetail
{
    
    public EntityDetailImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName OWNER$2 = 
        new javax.xml.namespace.QName("http://komadu.d2i.indiana.edu/query", "owner");
    private static final javax.xml.namespace.QName CREATIONDATE$4 = 
        new javax.xml.namespace.QName("http://komadu.d2i.indiana.edu/query", "creationDate");
    private static final javax.xml.namespace.QName SIZE$6 = 
        new javax.xml.namespace.QName("http://komadu.d2i.indiana.edu/query", "size");
    private static final javax.xml.namespace.QName MD5$8 = 
        new javax.xml.namespace.QName("http://komadu.d2i.indiana.edu/query", "md5");
    ...
    private static final javax.xml.namespace.QName COLLECTIONURI$14 = 
        new javax.xml.namespace.QName("http://komadu.d2i.indiana.edu/query", "collectionURI");
    private static final javax.xml.namespace.QName MEMBERSHIP$16 = 
        new javax.xml.namespace.QName("http://komadu.d2i.indiana.edu/query", "membership");
     ...
     */
    public edu.indiana.d2i.komadu.query.MembershipDetail[] getMembershipArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            edu.indiana.d2i.komadu.query.MembershipDetail[] result = new edu.indiana.d2i.komadu.query.MembershipDetail[targetList.size()];
     ...
     */
    public edu.indiana.d2i.komadu.query.MembershipDetail getMembershipArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.indiana.d2i.komadu.query.MembershipDetail target = null;
            target = (edu.indiana.d2i.komadu.query.MembershipDetail)get_store().find_element_user(MEMBERSHIP$16, i);
            if (target == null)
            {
     ...
     */
    public void setMembershipArray(edu.indiana.d2i.komadu.query.MembershipDetail[] membershipArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setMembershipArray(int i, edu.indiana.d2i.komadu.query.MembershipDetail membership)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public edu.indiana.d2i.komadu.query.MembershipDetail insertNewMembership(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.indiana.d2i.komadu.query.MembershipDetail target = null;
            target = (edu.indiana.d2i.komadu.query.MembershipDetail)get_store().insert_element_user(MEMBERSHIP$16, i);
            return target;
        }
    }
     ...
     */
    public edu.indiana.d2i.komadu.query.MembershipDetail addNewMembership()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.indiana.d2i.komadu.query.MembershipDetail target = null;
            target = (edu.indiana.d2i.komadu.query.MembershipDetail)get_store().add_element_user(MEMBERSHIP$16);
            return target;
        }
    }
